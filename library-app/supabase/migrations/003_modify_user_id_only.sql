...
ALTER TABLE bookshelves DROP CONSTRAINT IF EXISTS bookshelves_user_id_fkey;
...
ALTER TABLE bookshelves ALTER COLUMN user_id TYPE TEXT USING user_id::TEXT;
ALTER TABLE analytics ALTER COLUMN user_id TYPE TEXT USING user_id::TEXT;
ALTER TABLE reading_history ALTER COLUMN user_id TYPE TEXT USING user_id::TEXT;
